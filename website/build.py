...
def shell(name,body,source=""):
    nav='<a href="/">课程目录</a><a href="'+route("site/RUNNING.zh-CN.md")+'">运行说明与验证范围</a><a href="'+route(ZH+"README.md")+'">完整课程说明</a><p class="label">12 周 · 系统学习</p>'
...
for source,path in files.items():
    ...
    if path.suffix==".md":
        ...
        body+='<div class="notice">本页展示学习代码。执行请使用本地 Jupyter 或 Colab，并先阅读<a href="'+route("site/RUNNING.zh-CN.md")+'">运行说明与验证范围</a>。尚未保证全部高级课程可以直接运行。</div><div class="actions"><a href="/downloads/'+quote(source,safe="/")+'" download>下载代码</a><a href="'+REPO+'/blob/'+REV+'/'+quote(source,safe="/")+'">查看源码</a>'
...
body='<p class="label">AI FOR BEGINNERS / 简体中文</p><h1>人工智能，从理解到实践</h1><p>12 周 · 24 课 · 附多模态拓展<br>阅读中文讲义，结合 Python、PyTorch 与 TensorFlow 完成动手练习。</p><div class="actions"><a href="'+route(rows[1][2])+'">阅读第一课</a><a href="'+route("site/RUNNING.zh-CN.md")+'">准备运行环境</a></div><h2>课程目录</h2>'
